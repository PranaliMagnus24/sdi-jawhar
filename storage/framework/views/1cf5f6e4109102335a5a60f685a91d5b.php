...
<div class="form-wrapper">
  ...
  <div class="form-header">
    ...
    <small>Mob: <?php echo e($general->contact ?? ''); ?></small>
  </div>
  ...
  <div class="form-body">
    <div class="text-center mb-4">
      ...
      <a href="<?php echo e(url('/qurbanis/create')); ?>" class="btn btn-primary mt-3">Back</a>
    </div>
  </div>
...
<?php /**PATH /home/sites/20a/5/57972816bd/public_html/sdi_jawhar/resources/views/qurbanis/thank_your.blade.php ENDPATH**/ ?>